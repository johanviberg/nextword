    ...
    return (
      <button
        ...
        className={cn(
          ...
          //#region  //*=========== Size ===========
          [size === "base" && ["px-3 py-1.5", "text-sm md:text-base"], size === "sm" && ["px-2 py-1", "text-xs md:text-sm"]],
          //#endregion  //*======== Size ===========
          //#region  //*=========== Variants ===========
          [
            variant === "primary" && [
      ...
      >
        ...
        {LeftIcon && (
          <div className={cn([size === "base" && "mr-1", size === "sm" && "mr-1.5"])}>
            <LeftIcon
              size="1em"
              className={cn([size === "base" && "md:text-md text-md", size === "sm" && "md:text-md text-sm"], classNames?.leftIcon)}
            />
          </div>
        )}
        {children}
        {RightIcon && (
          <div className={cn([size === "base" && "ml-1", size === "sm" && "ml-1.5"])}>
            <RightIcon
              size="1em"
              className={cn([size === "base" && "text-md md:text-md", size === "sm" && "md:text-md text-sm"], classNames?.rightIcon)}
            />
          </div>
        )}
      </button>
